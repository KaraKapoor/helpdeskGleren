module.exports = {
    ...
    GET_LOGGED_IN_USER_DEPARTMENTS:"Select * from departments d where d.id in (Select department_id from team_agent_associations as a where team_lead_id=:id or agent_id=:id or user_id=:id and tenant_id=:tenantId) and tenant_id=:tenantId;",
