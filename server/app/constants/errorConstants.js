module.exports = {
  ...
  INVALID_RESET_PASSWORD_LINK_ERROR:
    "Invalid or reset password link is expired",
  ...
  MAX_USER_ERROR:
    "Your current plan supports only {userCount} Users. Please upgrade your plan.",
  INACTIVE_ACCOUNT_ERROR:
    "Your account is Inactive. Please contact your system administrator",
  SAME_ESCALATION_ERROR:
    "Escalation Details for same department already exist.",
