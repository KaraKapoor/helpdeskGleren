...
exports.createProject = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getProjectByName(
      input.projectName,
      tenantId
    );
    if (isNew && response?.name) {
      ...
      !isNew &&
      input?.projectName === response?.name &&
      ...
      const resp = await adminAPIService.createProject(
        input.projectName,
        input.id,
        input.is_active,
        tenantId
...
exports.getAllProjects = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getAllProjectsWithPagination(
      page,
      size,
      tenantId
    );
...
exports.createStatus = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getStatusByName(
      input.statusName,
      tenantId
    );
    if (isNew && response?.name) {
      ...
      !isNew &&
      input?.statusName === response?.name &&
      response.id != input.id
    ) {
      return res.status(200).send({
        error: errorConstants.STATUS_NAME_SAME_ERROR,
      ...
      const resp = await adminAPIService.createStatus(
        input.statusName,
        input.id,
        input.is_active,
        tenantId,
...
exports.getAllStatus = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getAllStatussWithPagination(
      page,
      size,
      tenantId
    );
...
exports.bugReportEmail = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.bugReportEmail(
      input.issueDescription,
      tenantId
    );
    return res.status(200).send({
...
exports.createDepartment = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getDepartmentByName(
      input.departmentName,
      tenantId
    );
    if (isNew && response?.name) {
      ...
      !isNew &&
      input?.departmentName === response?.name &&
      response.id != input.id
    ) {
      return res.status(200).send({
        error: errorConstants.DEPARTMENT_NAME_SAME_ERROR,
      ...
      const resp = await adminAPIService.createDepartment(
        input.departmentName,
        input.id,
        input.is_active,
        tenantId
...
exports.getDepartmentById = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getDepartmentById(
      input.id,
      tenantId
    );
    return res.status(200).send({ status: true, data: response });
...
exports.getAllDepartments = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getAllDepartmentsWithPagination(
      page,
      size,
      tenantId
    );
...
exports.masterDropDownData = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.masterDropdownData(
      tenantId,
      req.user.user_id
    );
    return res.status(200).send({ status: true, data: response });
...
exports.createEscalationMatrix = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getEscalationByDepartmentId(
      input.departmentId,
      tenantId
    );
    if (isNew && response?.department_id) {
      ...
      !isNew &&
      input?.departmentId === response?.department_id &&
      response.id != input.id
    ) {
      return res.status(200).send({
        error: errorConstants.SAME_ESCALATION_ERROR,
      ...
      const resp = await adminAPIService.createEscalations(
        input.departmentId,
        input.l1Id,
        input.l2Id,
        input.l3Id,
...
exports.getEscalationById = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getEscalationById(
      input.id,
      tenantId
    );
    return res.status(200).send({ status: true, data: response });
...
exports.getAllEscalations = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getAllEscalationsWithPagination(
      page,
      size,
      tenantId
    );
...
exports.getAllTeams = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getAllTeamsWithPagination(
      page,
      size,
      tenantId
    );
...
exports.createTeam = async (req, res) => {
  ...
  try {
    const response = await adminAPIService.getTeamByName(
      input.teamName,
      tenantId
    );
    if (isNew && response?.name) {
      ...
      const resp = await adminAPIService.createTeam(
        input.id,
        input.teamName,
        input.active,
        input.departmentId,
