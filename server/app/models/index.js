...
db.tenantSettings.belongsTo(db.tenant, {
    foreignKey: "tenant_id", //1:1
});
db.ticket.belongsTo(db.labels, {
    foreignKey:"label_id", // 1:M
})
