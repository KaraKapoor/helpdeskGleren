...
class addAdministrative extends Component {
    constructor(props) {
        super(props);
         this.saveUpdateAdministrativeEscalation = this.saveUpdateAdministrativeEscalation.bind(this);
	...
	this.onChangehodemail = this.onChangehodemail.bind(this);
        ...
        this.state = {
               ...
               branch:undefined,
                ...
                hodmobile: undefined,
                hodemail: undefined,
                idadministrativeescalation: undefined
    };
        this.isViewMode = false;
        if (window.location.href.includes('/id:')) {
          var currentUrl = window.location.href;
          var idParam = currentUrl.split("/id:")
          this.state.idadministrativeescalation = idParam[1];
            this.isViewMode = true;
        }
    }

   async componentDidMount() {
      if(this.state.idadministrativeescalation!==undefined){
        const data={
          id:this.state.idadministrativeescalation
        }
        const resp=await TicketDataService.getAdministrativeEscalationById(data);
        console.log(resp);
 ...
 onChangel1name(e) {
  ...
  onChangehodemail(e) {
    ...
    async saveUpdateAdministrativeEscalation() {
      let data = {};
      if (this.state.idadministrativeescalation) {
          data = {
          ...
          await TicketDataService.createUpdateAdministrative(data).then((resp) => {
              if (resp) {
                this.showSuccessToast(" Details Submitted Successfully");
                  this.props.history.push("/administrativeList");
              } else {
    ...
    async getAdministrativeEscalationDetails(){
        const data = {
            idadministrativeescalation: this.state.idadministrativeescalation
        }
        const resp = await  TicketDataService.getAdministrativeEscalationById(data);
        this.setState({department:resp.data.department});
        ...
        for (let i of resp.data) {
            this.getAdministrativeEscalationDetails(i.value);
        ...
        <h5 className="formHeading">Administrative Escalation</h5>
          <div class="shadow p-3 mb-5 rounded" style={{ backgroundColor: "#ffffff" }}>
            ...
            <Form>
              ...
              <label className="subHeading"><b>Hod Detail</b> </label>
              <Form.Group className="mb-3">
              ...
              <Button style={{ color: "#fff", backgroundColor: "#1f3143" }} variant="primary" type="button" onClick={this.saveUpdateAdministrativeEscalation}>
...
export default addAdministrative;