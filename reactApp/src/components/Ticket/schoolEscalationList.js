...
class schoolEscalationList extends Component {
    ...
    constructor(props) {
        ...
        this.columns = [
            { title: "Escalation Id", field: "idschoolescalation", render: rowData =><span><i class="fa fa-users" aria-hidden="true"></i>
            &nbsp;&nbsp;<Link onClick={this.savePageLocation("/schoolList")}to={`/addSchoolEscalation/id:${rowData.idschoolescalation}`}>{rowData.idschoolescalation}</Link> 
            </span> },
    ...
    clickAdd() {
        this.props.history.push("/addSchoolEscalation");
    }
    async remoteData(query, status) {
        ...
        await TicketDataService.getAllSchoolEscalationList(query.pageSize, query.page, query.search, orderDirection, orderBy)
            .then(async (response) => {
                //let result = response.data;
                for (var i of response.data.schoolEscalationList) {
                    i.idschoolescalation = i.idschoolescalation;
                    i.branch = i.branch;
                    i.department = i.department;
                    i.module=i.module;
                    // i.helpdeskRole=i.helpdeskRole;
                }
                data =response.data.schoolEscalationList;
    ...
    async exportData() {
        ...
        this.state.exportDataDownloadLink = url.baseURL + `/api/dataExport/downloadSchoolEscalation`;
...
export default schoolEscalationList;