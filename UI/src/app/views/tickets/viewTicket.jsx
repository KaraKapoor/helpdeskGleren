    ...
    const getTicketDetails = (id) => {
        getTicketById({ id: id }).then((resp) => {
            if (resp?.status === false) {
                ...
                setSelectedReporter(resp.data.createdBy.first_name + ' ' + resp.data.createdBy.last_name);
                ...
                setInitialValues({
                    ...
                    issueSummary: resp?.data?.issue_summary ? resp.data.issue_summary : '',
                                        ...
                                        <ContentBox>
                                            <Grid container spacing={3}>
                                                <Grid item lg={8} md={8} sm={12} xs={12}>
                                                    <TextField fullWidth size="large" required={true} name="issueDetails" type="text" label="Issue Details"
                                                        variant="outlined" onBlur={e => {
                                                            updateTicketDetails(e.target.value, 'issueDetails');
                                                    ...
                                                    <TextareaAutosize fullWidth size="large" style={{ width: '100%', outline: 'none', borderRadius: "5px" }} minRows={10} required={true} name="issueSummary" type="textarea" label="Issue Summary"
                                                        placeholder="Issue Description" variant="outlined" onBlur={e => {
                                                            updateTicketDetails(e.target.value, 'issueSummary');
                                                ...
                                                <Grid item lg={4} md={4} sm={12} xs={12}>
                                                    <Card sx={{ px: 3, py: 2, mb: 3 }}>
                                                        <TextField fullWidth size="small" disabled readOnly name="reporter" type="text" label="Reporter"
                                                            variant="outlined" onBlur={handleBlur} value={selectedReporter}
                                                            onChange={handleChange} sx={{ mb: 1.5 }} />
                                                        <TextField fullWidth size="small" disabled readOnly name="department" type="text" label="Department"
                                                            variant="outlined" onBlur={handleBlur} value={selectedDepartment}
                                                            onChange={handleChange} sx={{ mb: 1.5 }} />
                                                        <TextField fullWidth size="small" disabled readOnly name="project" type="text" label="Project"
                                                            variant="outlined" onBlur={handleBlur} value={selectedProject}
                                                            onChange={handleChange} sx={{ mb: 1.5 }} />
                                                        <FormControl fullWidth size="small">
                                                            <InputLabel required={true} id="assignee">Assignee</InputLabel>
                                                            <Select
                                                                labelId="assignee"
                                                                id="assignee"
                                                                required={true}
                                                        ...
                                                        <TextField fullWidth size="small" className='mt-2' name="fixVersion" type="text" label="Fix Version"
                                                            variant="outlined" onBlur={e => {
                                                                updateTicketDetails(e.target.value, 'fixVersion');
                                                            }} value={values.fixVersion}
                                                            onChange={handleChange} sx={{ mb: 1.5 }} />
                                                        <TextField fullWidth size="small" className='mt-2' name="dueDate" type="date" label="Due Date"
                                                            variant="outlined" onBlur={e => {
                                                                updateTicketDetails(e.target.value, 'dueDate');
                                                            }} value={values.dueDate}
                                                            onChange={handleChange} sx={{ mb: 1.5 }} />
                                                        <TextField fullWidth size="small" className='mt-2' name="storyPoints" type="number" label="Story Points"
                                                            variant="outlined" onBlur={e => {
                                                                updateTicketDetails(e.target.value, 'storyPoints');
                                                        ...
                                                        <InputLabel id="createdAT" className='mt-2'>Created Date: {moment(editData.createdAt).format('DD-MM-YYYY HH:mm')}</InputLabel>
                                                        <InputLabel id="updatedAT">Modified Date: {moment(editData.updatedAt).format('DD-MM-YYYY HH:mm')}</InputLabel>
                                                    </Card>
                                                </Grid>
                                            </Grid>
                                        </ContentBox>
