                            ...
                            <form onSubmit={handleSubmit}>
                                <FormContainer>
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <FormControl fullWidth>
                                                <InputLabel required={true} id="category">Category</InputLabel>
                                                <Select
                                                    labelId="category"
                                                    id="category"
                                                    required={true}
                                        ...
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <FormControl fullWidth>
                                                <InputLabel required={true} id="status">Status</InputLabel>
                                                <Select
                                                    labelId="status"
                                                    id="status"
                                                    required={true}
                                        ...
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <FormControl fullWidth>
                                                <InputLabel required={true} id="priority">Priority</InputLabel>
                                                <Select
                                                    labelId="priority"
                                                    id="priority"
                                                    required={true}
                                        ...
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <TextField fullWidth size="large" name="fixVersion" type="text" label="Fix Version"
                                                variant="outlined" onBlur={handleBlur} value={values.fixVersion}
                                                onChange={handleChange} sx={{ mb: 1.5 }} />
                                        </Grid>
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <TextField fullWidth size="large" name="dueDate" type="date" label="Due Date"
                                                variant="outlined" onBlur={handleBlur} value={values.dueDate}
                                                onChange={handleChange} sx={{ mb: 1.5 }} />
                                        </Grid>
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <TextField fullWidth size="large" name="storyPoints" type="number" label="Story Points"
                                                variant="outlined" onBlur={handleBlur} value={values.storyPoints}
                                                onChange={handleChange} sx={{ mb: 1.5 }} />
                                        </Grid>
                                        <Grid item lg={12} md={12} sm={12} xs={12}>
                                            <TextField fullWidth size="large" required={true} name="issueDetails" type="text" label="Issue Details"
                                                variant="outlined" onBlur={handleBlur} value={values.issueDetails}
                                                onChange={handleChange} sx={{ mb: 1.5 }} />
                                        </Grid>
                                        <Grid item lg={12} md={12} sm={12} xs={12}>
